...
import { Subject, Observable } from 'rxjs'; // Subject serve per creare un "canale di comunicazione" interno
...
export class Sinistri {
  ...
  // Il Subject è una "sorgente" di dati che può emettere nuovi valori a chiunque sia in ascolto
